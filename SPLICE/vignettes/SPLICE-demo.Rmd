---
title: "Enhanced SynthETIC: An Individual Incurred Loss Simulator"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Enhanced SynthETIC: An Individual Incurred Loss Simulator}
...
This vignette aims to illustrate how the updated `SynthETIC` package (Version 1.0.0+) can be used to generate the case estimates of incurred losses, as an addition to the earlier program which simulates paid claim experience of individual claims at a transactional level. See [the first vignette here](https://CRAN.R-project.org/package=SynthETIC) for a detailed example on how to use the package to simulate paid claim experience.

The incurred program is structured as follows:
